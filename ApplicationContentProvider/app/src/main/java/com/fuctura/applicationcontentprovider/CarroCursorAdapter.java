...
public class CarroCursorAdapter extends CursorAdapter {
    ...
    public long getItemId(int position) {
        ...
        return cur.getLong(cur.getColumnIndexOrThrow(CarroProviderContract.COLUMN_ID));
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        txtNome.setText(
                cursor.getString(cursor.getColumnIndex(CarroProviderContract.COLUMN_NOME))
        );

        txtPlaca.setText(
                cursor.getString(cursor.getColumnIndex(CarroProviderContract.COLUMN_PLACA))
        );

        txtAno.setText(
                cursor.getString(cursor.getColumnIndex(CarroProviderContract.COLUMN_ANO))
        );
    }
